...
alias undockx='xrandr --output eDP1 --mode 1366x768 --right-of DP2-3 --output DP2-3 --mode 1920x1080'
alias beamer_connect='xrandr --output eDP1 --mode 1366x768 --left-of VGA1 --output VGA1 --primary --mode 1024x768'
alias nano='vim'
alias edit='vim'
alias ed='vim'
alias emas='vim'
