...
function startwm {
    rm ~/.config/X11/xinitrc
    ln -s ~/.config/X11/xinitrc"$1" ~/.config/X11/xinitrc
    startx
}
...
# execute
mvhome
./files/projects/dotfiles/scripts/dotfiles.sh
pacman -Qqe > files/projects/dotfiles/pkglist.txt
